...
export default function TransactionModal({ isOpen, status, step, totalSteps, txHash }: TransactionModalProps) {
        ...
        <div className="text-center">
          ...
          {txHash && (
            <div className="bg-[var(--color-bg-primary)] border border-[var(--color-border)] rounded-lg p-3 mt-4">
              <div className="text-sm text-[var(--color-text-muted)] mb-1">Transaction Hash:</div>
